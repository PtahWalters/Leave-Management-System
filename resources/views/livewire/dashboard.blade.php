          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-2 text-capitalize font-weight-bold">Employees on leave</p>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-2 text-capitalize font-weight-bold">Unprocessed leave requests</p>
                    <h4 class="font-weight-bolder mb-0">
                      10
                    </h4>
                  </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-2 text-capitalize font-weight-bold">Declined leave requests</p>
                    <h4 class="font-weight-bolder mb-0">
                      3
                    </h4>
                  </div>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-2 text-capitalize font-weight-bold">Approved leave requests</p>
                    <h4 class="font-weight-bolder mb-0">
                      12
                    </h4>
                  </div>
